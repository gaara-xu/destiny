...
public class Destiny {
     ...
     * @return
     */
    public static String getAdmin64Info(int index){
        return getAdmin64Info().get(index);
    }
     ...
     * @return
     */
    public static Object getXXInfoByindexAndXX(int index,int xx){
        return getXInfo().get(index+"+"+xx);
    }
     ...
     * @return
     */
    public static Map<Integer,String> getAdmin64Info(){
        Map<Integer,String> map = new HashMap<>(64);
        map.put(1,"乾卦原文\n" +
                "乾。元，亨，利，贞。\n" +
                "象曰：天行健，君子以自强不息。\n" +
    ...
    public static Map<String,Object> getXInfo(){
        ...
        map.put("7+1","初六爻辞\n" +
                ...
                "占得此卦者，如果自己是老板或领导的话，一定要注意严明纪律，人好不如制度好，如果对一切行为活动都制定了准则，并严格按此来执行，那么部下的工作就会井井有条。一定要对下面的人严格约束，不然公司或单位将面临危");
        map.put("7+2","九二爻辞\n" +
                "九二。在师中，吉无咎，王三锡命。\n" +
        ...
        map.put("33+5","九五爻辞\n" +
                ...
                "嘉遁的典型例子便是周公的事迹。周公对西周的贡献太大了，他平叛了“三叔”之乱，一举东征，不但扩大了西周的疆域，而且使西周的政权得到了巩固。东征归来后制礼作乐，总结前代贤人的治国之道，完善了礼乐治国的理论，为封建社会的社会治理开创了新的规范。可是他尽管这么有能力，却没有坐在君王的位子上不下来。而是功成身退，把君王的位子又还给了成王。");
        map.put("33+6","上九爻辞\n" +
                "上九。肥遁，无不利。\n" +
                "象曰：肥遁无不利，无所疑也。\n" +
                "白话文解释\n" +
